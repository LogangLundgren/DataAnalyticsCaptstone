...
def extract_exercise_type(filename):
    ...
    """
    # Example: if filename is "squat_set1.mp4" or "squat_1" etc.
    return filename.split('_')[0].lower()

# First, install required packages
!pip install supabase pandas numpy scikit-learn seaborn matplotlib
...
def load_data_from_supabase():
    ...
    while True:
        ...
        # Optional: limit total rows for testing
...
- This project uses machine learning to classify different types of exercises from body position data
- We're using a Random Forest Classifier because:
  1. It handles complex body position data well
  2. It's resistant to overfitting
  3. It gives us insight into which body positions are most important
  4. It's relatively fast to train and make predictions
"""
